...
import "../css/HumidityChart.css"; // Import file CSS nếu cần

// Hàm định dạng thời gian để hiển thị đẹp trên trục X
  ...
  <Card className="chart-card" sx={{ padding: 2, backgroundColor: "#f9f9f9" }}>
    ...
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={data}>
        ...
        <Legend />
        <Line type="monotone" dataKey="humidity" stroke="#2196f3" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
      </LineChart>
    </ResponsiveContainer>
  </Card>
);
